...
const FinalQuizNavbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <nav className="hidden md:flex gap-5 text-sm">
        ...
        <Link href="/final-quiz" className="text-gray-800 font-semibold border-b-2 border-gray-800 pb-0.5">
          Final Quiz
        </Link>
      </nav>
...
export default FinalQuizNavbar;
