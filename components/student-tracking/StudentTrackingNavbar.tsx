...
const StudentTrackingNavbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <nav className="hidden md:flex gap-5 text-sm">
        ...
        <Link href="/student-tracking" className="text-gray-800 font-semibold border-b-2 border-gray-800 pb-0.5">
          Student Tracking
        </Link>
...
export default StudentTrackingNavbar;
