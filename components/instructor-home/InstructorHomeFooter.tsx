...
const InstructorHomeFooter: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-[#FF8A00] to-[#FFB84D] text-white py-12 mt-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <Link href="/instructor-home" className="hover:underline opacity-90 hover:opacity-100 transition-opacity">
                  Home
                </Link>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-orange-200">•</span>
                <Link href="/courses-management" className="hover:underline opacity-90 hover:opacity-100 transition-opacity">
                  Courses
                </Link>
              </li>
              <li className="flex items-center gap-2">
