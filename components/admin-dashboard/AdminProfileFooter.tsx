      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
        ...
        <div className="footer-card rounded-2xl p-5 slide-in" style={{ animationDelay: '0.2s', opacity: 0 }}>
          ...
          <ul className="space-y-2 text-sm text-[#5D4E37]">
            <li className="footer-link"><Link href="/admin-dashboard">Home</Link></li>
            <li className="footer-link"><Link href="/admin-courses">All Courses</Link></li>
            <li className="footer-link"><Link href="/admin-users">Users</Link></li>
        ...
        <div className="footer-card rounded-2xl p-5 slide-in" style={{ animationDelay: '0.4s', opacity: 0 }}>
          ...
          <ul className="space-y-2 text-sm text-[#5D4E37]">
            <li className="footer-link"><Link href="/admin-profile">My Profile</Link></li>
            <li className="footer-link"><Link href="/admin-courses">My Courses</Link></li>
